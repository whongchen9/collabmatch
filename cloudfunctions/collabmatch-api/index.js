...
const DOMAIN_SKILL_MAP={tech:['generate_prd','diagnose','optimize','estimate','invite','summary','generate_ui'],design:['generate_prd','diagnose','optimize','estimate','invite','generate_ui'],content:['generate_prd','diagnose','optimize','invite','generate_ui'],education:['generate_prd','diagnose','optimize','estimate','invite','generate_ui'],business:['generate_prd','diagnose','optimize','estimate','invite','generate_ui']};
...
G('/api/config', ()=>({authMode:'dev',devAuthCode:DEV_AUTH_CODE,domains:{tech:{id:'tech',name:'💻 技术开发',icon:'💻'},design:{id:'design',name:'🎨 创意设计',icon:'🎨'},content:{id:'content',name:'✍️ 内容创作',icon:'✍️'},education:{id:'education',name:'📚 知识教育',icon:'📚'},business:{id:'business',name:'💼 商业运营',icon:'💼'}}}));
